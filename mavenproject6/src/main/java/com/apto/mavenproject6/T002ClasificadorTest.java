...
@NamedQueries({
    ...
    @NamedQuery(name = "T002ClasificadorTest.findByIdClasificadortest", query = "SELECT t FROM T002ClasificadorTest t WHERE t.idClasificadortest = :idClasificadortest"),
    @NamedQuery(name = "T002ClasificadorTest.findByDescripcionClasificador", query = "SELECT t FROM T002ClasificadorTest t WHERE t.descripcionClasificador = :descripcionClasificador"),
    @NamedQuery(name = "T002ClasificadorTest.findByIdRecursivoTest", query = "SELECT t FROM T002ClasificadorTest t WHERE t.idRecursivoTest = :idRecursivoTest")})
public class T002ClasificadorTest implements Serializable {
    ...
    public String toString() {
        return "com.apto.mavenproject6.T002ClasificadorTest[ idClasificadortest=" + idClasificadortest + " ]";
    }
