 ...
 */
package ec.com.neurotest.fachadas.generafactura;
 ...
 */
@Stateless
public class V001GeneraFacturaFacade extends AbstractFacade<V001GeneraFactura> {
    ...
    public V001GeneraFacturaFacade() {
        super(V001GeneraFactura.class);
    }
